...
class KDE:
    ...
    def define_support(self, x1, x2=..., weights=..., cache=...): # -> ndarray[Unknown, Unknown] | tuple[ndarray[Unknown, Unknown], ndarray[Unknown, Unknown]]:
        """Create the evaluation grid for a given data set."""
        ...
    
    def __call__(self, x1, x2=..., weights=...): # -> tuple[ndarray[Unknown, Unknown] | Unknown, ndarray[Unknown, Unknown] | tuple[ndarray[Unknown, Unknown], ndarray[Unknown, Unknown]]]:
...
class Histogram:
    ...
    def define_bin_params(self, x1, x2=..., weights=..., cache=...):
        """Given data, return numpy.histogram parameters to define bins."""
        ...
    
    def __call__(self, x1, x2=..., weights=...): # -> tuple[Unknown, Unknown] | tuple[Unknown, list[Unknown]]:
