...
class HueMapping(SemanticMapping):
    ...
    def categorical_mapping(self, data, palette, order): # -> tuple[Unknown, dict[Unknown, Unknown] | dict[Unknown, tuple[float, float, float] | str]]:
        """Determine colors when the hue mapping is categorical."""
        ...
    
    def numeric_mapping(self, data, palette, norm): # -> tuple[list[Unknown] | list[Any], dict[Unknown, Unknown] | dict[Any, Unknown | Any], Unknown, Unknown | _ColorPalette | list[tuple[float, float, float]] | Any | list[str] | Literal['ch:']]:
...
class SizeMapping(SemanticMapping):
    ...
    def categorical_mapping(self, data, sizes, order): # -> tuple[Unknown, dict[Unknown, Unknown]]:
        ...
...
def variable_type(vector, boolean_type=...): # -> Literal['categorical', 'numeric', 'datetime']:
    """
