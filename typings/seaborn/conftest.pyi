...
@pytest.fixture
def wide_array(wide_df): # -> ndarray[Unknown, Unknown]:
    ...

@pytest.fixture
def flat_series(rng): # -> Series[Unknown]:
    ...

@pytest.fixture
def flat_array(flat_series): # -> ndarray[Unknown, Unknown]:
    ...
...
@pytest.fixture
def wide_list_of_series(rng): # -> list[Series[Unknown]]:
    ...

@pytest.fixture
def wide_list_of_arrays(wide_list_of_series): # -> list[ndarray[Unknown, Unknown]]:
    ...
...
@pytest.fixture
def wide_dict_of_arrays(wide_list_of_series): # -> dict[Unknown, ndarray[Unknown, Unknown]]:
    ...
