...
class _CategoricalPlotter:
    ...
    @property
    def hue_offsets(self): # -> Any | ndarray[Unknown, Unknown]:
...
class _ViolinPlotter(_CategoricalPlotter):
    ...
    def kde_support(self, x, bw, cut, gridsize): # -> ndarray[Unknown, Unknown]:
...
class _SwarmPlotter(_CategoricalScatterPlotter):
    ...
    def could_overlap(self, xy_i, swarm, d): # -> ndarray[Unknown, Unknown]:
    ...
    def position_candidates(self, xy_i, neighbors, d): # -> ndarray[Unknown, Unknown]:
    ...
    def beeswarm(self, orig_xy, d): # -> ndarray[Unknown, Unknown]:
...
class _PointPlotter(_CategoricalStatPlotter):
    ...
    @property
    def hue_offsets(self): # -> ndarray[Unknown, Unknown]:
...
def factorplot(*args, **kwargs): # -> FacetGrid:
