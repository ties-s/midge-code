...
#define MANUFACTURER_NAME               "protonotarios.info" 				                    /**< Manufacturer. Will be passed to Device Information Service. */
#define APP_ADV_INTERVAL                800                                         /**< The advertising interval (in units of 0.625 ms. This value corresponds to 500 ms). */
#define APP_ADV_DURATION                0	                                       	/**< The advertising duration (always) in units of 10 milliseconds. */
...
#define SEC_PARAM_IO_CAPABILITIES       BLE_GAP_IO_CAPS_NONE		                /**< Display only = static passkey(?). */
...
static void battery_level_meas_timeout_handler(void * p_context)
{
    ...
    ret_code_t err_code = ble_bas_battery_level_update(&m_bas, batt_lvl_in_percentage, BLE_CONN_HANDLE_ALL);
    if ((err_code != NRF_SUCCESS) &&
...
//    APP_ERROR_CHECK(err_code);
    ...
    bas_init.initial_batt_level   = batt_lvl_in_percentage;
